...
%%clear DATATEXT;
test_length=300000;
figure(1),subplot(3,1,1),plot(DATATEXT_N(45000:75000,2),'r'),title('A01');  % MIC. sensor
...
figure(1),subplot(3,1,2),plot(DATATEXT_Y(70000:100000,2),'b'),title('A02');  % MIC. sensor
axis([-inf inf -1.5 1.5]);
load 'U_Run_05K_03.txt';
DATATEXT_YY=U_Run_05K_03;
figure(1),subplot(3,1,3),plot(DATATEXT_YY(60000:90000,2),'g'),title('A03');  % MIC. sensor
axis([-inf inf -1.5 1.5]);
