...
%%clear DATATEXT;
test_length=300000;
figure(1),subplot(3,1,1),plot(DATATEXT_N(70000:130000,2),'r'),title('A01');  % MIC. sensor
...
figure(1),subplot(3,1,2),plot(DATATEXT_Y(70000:130000,2),'b'),title('A02');  % MIC. sensor
axis([-inf inf -1.5 1.5]);
load 'U_Run_10K_03.txt';
DATATEXT_YY=U_Run_10K_03;
figure(1),subplot(3,1,3),plot(DATATEXT_YY(70000:130000,2),'g'),title('A03');  % MIC. sensor
axis([-inf inf -1.5 1.5]);
...
figure(3),subplot(3,1,1),plot(freq1(1,1:25001), 20*log10(mag1(1:25001,1)),'r');axis([-inf inf -40 40]);legend A01;
title('Energy spectrum (dB)'); xlabel('Frequency'); ylabel('Magnitude');
figure(3),subplot(3,1,2),plot(freq2(1,1:25001), 20*log10(mag2(1:25001,1)),'b');axis([-inf inf -40 40]);legend A02;
title('Energy spectrum (dB)'); xlabel('Frequency'); ylabel('Magnitude');
figure(3),subplot(3,1,3),plot(freq5(1,1:25001), 20*log10(mag5(1:25001,1)),'k');axis([-inf inf -40 40]);legend A03;
title('Energy spectrum (dB)'); xlabel('Frequency'); ylabel('Magnitude');
