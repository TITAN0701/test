...
%%clear DATATEXT;
test_length=300000;
figure(1),subplot(3,1,1),plot(DATATEXT_N(05000:35000,2),'r'),title('A01');  % MIC. sensor
axis([-inf inf -1.5 1.5]);
load 'U_Run_05K_02.txt';
DATATEXT_Y=U_Run_05K_02;
figure(1),subplot(3,1,2),plot(DATATEXT_Y(35000:65000,2),'b'),title('A02');  % MIC. sensor
axis([-inf inf -1.5 1.5]);
load 'U_Run_05K_03.txt';
DATATEXT_YY=U_Run_05K_03;
figure(1),subplot(3,1,3),plot(DATATEXT_YY(30000:60000,2),'g'),title('A03');  % MIC. sensor
axis([-inf inf -1.5 1.5]);
